...
public class GpsGUI {
    ...
    public static void main(String[] args) {
        ...
        Double[] altitudes = { -1385.0, -1385.0, -1385.0, -1385.0, -1385.0, -1385.0, -1385.0, -1385.0, -1385.0,
                -1385.0 };
        ...
        Cell<String> textDistance0 = inputDistance0.sUserChanges.hold(bufferDistance0.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        Cell<String> textDistance1 = inputDistance1.sUserChanges.hold(bufferDistance1.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        Cell<String> textDistance2 = inputDistance2.sUserChanges.hold(bufferDistance2.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        Cell<String> textDistance3 = inputDistance3.sUserChanges.hold(bufferDistance3.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        Cell<String> textDistance4 = inputDistance4.sUserChanges.hold(bufferDistance4.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        Cell<String> textDistance5 = inputDistance5.sUserChanges.hold(bufferDistance5.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        Cell<String> textDistance6 = inputDistance6.sUserChanges.hold(bufferDistance6.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        Cell<String> textDistance7 = inputDistance7.sUserChanges.hold(bufferDistance7.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        Cell<String> textDistance8 = inputDistance8.sUserChanges.hold(bufferDistance8.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        Cell<String> textDistance9 = inputDistance9.sUserChanges.hold(bufferDistance9.getText()); // Hold buffer value
                                                                                                  // so value doesnt
                                                                                                  // disappear
        ...
        ActionListener buttonPerformer = new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                if (valid) {
                    if (latitudes[0] > latitude || longitudes[0] > longitude || latitudes[0] < minLat
                    ...
                    if (latitudes[1] > latitude || longitudes[1] > longitude || latitudes[1] < minLat
                            || longitudes[1] < minLong) {
                    ...
                    if (latitudes[2] > latitude || longitudes[2] > longitude || latitudes[2] < minLat
                            || longitudes[2] < minLong) {
                    ...
                    if (latitudes[3] > latitude || longitudes[3] > longitude || latitudes[3] < minLat
                            || longitudes[3] < minLong) {
                    ...
                    if (latitudes[4] > latitude || longitudes[4] > longitude || latitudes[4] < minLat
                            || longitudes[4] < minLong) {
                    ...
                    if (latitudes[5] > latitude || longitudes[5] > longitude || latitudes[5] < minLat
                            || longitudes[5] < minLong) {
                    ...
                    if (latitudes[6] > latitude || longitudes[6] > longitude || latitudes[6] < minLat
                            || longitudes[6] < minLong) {
                    ...
                    if (latitudes[7] > latitude || longitudes[7] > longitude || latitudes[7] < minLat
                            || longitudes[7] < minLong) {
                    ...
                    if (latitudes[8] > latitude || longitudes[8] > longitude || latitudes[8] < minLat
                            || longitudes[8] < minLong) {
                    ...
                    if (latitudes[9] > latitude || longitudes[9] > longitude || latitudes[9] < minLat
                            || longitudes[9] < minLong) {
        ...
        for (Stream<GpsEvent> s : streams) {
            ...
            s.listen((GpsEvent ev) -> {
                ...
                if (ev.name.equals("Tracker0")) {
                    ...
                    inputTimestamp.replaceSelection(ev.name + ", " + ev.latitude + ", " + ev.longitude + ", "
                    ...
                    if (fitsCriteria[0] == true) {
                        ...
                        if (altitudes[0] != -1385.0) {
                            ...
                            RolledWindowStamp rolled = new RolledWindowStamp(
                                    ZonedDateTime.now().toInstant().toEpochMilli(), updatedDistance);
                        ...
                        for (int i = 0; i < rollingWindow0.size(); i++) {
                            if (rollingWindow0.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
                ...
                if (ev.name.equals("Tracker1")) {
                    ...
                    if (fitsCriteria[1] == true) {
                        ...
                        for (int i = 0; i < rollingWindow1.size(); i++) {
                            if (rollingWindow1.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
                ...
                if (ev.name.equals("Tracker2")) {
                    ...
                    if (fitsCriteria[2] == true) {
                        ...
                        for (int i = 0; i < rollingWindow2.size(); i++) {
                            if (rollingWindow2.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
                ...
                if (ev.name.equals("Tracker3")) {
                    ...
                    if (fitsCriteria[3] == true) {
                        ...
                        for (int i = 0; i < rollingWindow3.size(); i++) {
                            if (rollingWindow3.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
                ...
                if (ev.name.equals("Tracker4")) {
                    ...
                    if (fitsCriteria[4] == true) {
                        ...
                        for (int i = 0; i < rollingWindow4.size(); i++) {
                            if (rollingWindow4.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
                ...
                if (ev.name.equals("Tracker5")) {
                    ...
                    if (fitsCriteria[5] == true) {
                        ...
                        for (int i = 0; i < rollingWindow5.size(); i++) {
                            if (rollingWindow5.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
                ...
                if (ev.name.equals("Tracker6")) {
                    ...
                    if (fitsCriteria[6] == true) {
                        ...
                        for (int i = 0; i < rollingWindow6.size(); i++) {
                            if (rollingWindow6.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
                ...
                if (ev.name.equals("Tracker7")) {
                    ...
                    if (fitsCriteria[7] == true) {
                        ...
                        for (int i = 0; i < rollingWindow7.size(); i++) {
                            if (rollingWindow7.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
                ...
                if (ev.name.equals("Tracker8")) {
                    ...
                    if (fitsCriteria[8] == true) {
                        ...
                        for (int i = 0; i < rollingWindow8.size(); i++) {
                            if (rollingWindow8.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
                ...
                if (ev.name.equals("Tracker9")) {
                    ...
                    if (fitsCriteria[9] == true) {
                        ...
                        for (int i = 0; i < rollingWindow9.size(); i++) {
                            if (rollingWindow9.get(i).timeAdded > (ZonedDateTime.now().toInstant().toEpochMilli()
                                    - 300000)) {
